                  ...
                  <td className="px-5 py-4 text-right">
                    {v.status === 'expected' || v.status === 'waiting' ? (
                      <button
                        ...
                        className="h-10 px-3 rounded-lg bg-indigo-600 text-white hover:bg-indigo-700 text-xs font-bold transition-colors inline-flex items-center gap-1"
                      >
                      ...
                      <button
                        ...
                        className="h-10 px-3 rounded-lg bg-slate-900 text-white hover:bg-slate-800 text-xs font-bold transition-colors inline-flex items-center gap-1"
                      >
